...
namespace CrudAspNetMvc1N.Controllers
{
    public class ClientesController : Controller
    {
        ...
        {
            ViewBag.IdConsultor = new SelectList(db.Consultores, "IdConsultor", "Nome");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "Id,Nome,Email,IdConsultor,Telefones")] Cliente cliente)
        {
            ...
            ViewBag.IdConsultor = new SelectList(db.Consultores, "IdConsultor", "Nome", cliente.IdConsultor);
            return View(cliente);
        }
